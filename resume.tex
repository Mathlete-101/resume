...
{Bachelor's of Science in Computer Science }{GPA: 3.9}
\resumeItemListStart
...
\textbf{Languages \&Skills}{: Python, Java, C++, JS, Agile Methodologies, SAFe} \\
...
\resumeItem{Enhanced and debugged frontend of internal-use web application (VIE).}
...
\resumeItem{Debugged backend of internal-use web application (VIE).}
\resumeItemListEnd
...
% CCSP
\resumeSubheading
{Mines Prevasive Computing Research Group}{Sept 2023 -- Present}
{Research Assistant}{Golden, CO}
\resumeItemListStart
\resumeItem{Analyzed encoding techniques for delegating image recognition tasks from drones to edge compupting devices.}
\resumeItemListEnd
\resumeSubHeadingListEnd
...
\resumeSubheading
{Robotics}{2018 -- 2022}{Programming Department Co-Leader}{blah}
\resumeItemListStart
