...
\section{Research Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
        ...
        \vspace{-20pt}
        \resumeItemListStart
            \resumeItem{'Playing Games and Gaming Play: Navigating the Intersection of Concepts in Tension", Lead author Mark Jensen, presented at Agency and Reasoning in Games, University of Maine, September 2024}
        \resumeItemListEnd
...
\section{Projects}    %-----------PROJECTS-----------
    \resumeSubHeadingListStart
      \resumeProjectHeading{NASA Lunabotics}{September 2024 -- Present}
      \resumeItemListStart
        \resumeItem{Helped develop and clarify project plan and requirements in 12 person team according to NASA standards}
        \resumeItem{Improving software architecture from previous team}
        \resumeItem{Developing computer vision and navigation systems}
      \resumeItemListEnd
